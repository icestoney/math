...
START_TEST(s21_acos_test_1) {
  ...
  for (double i = 0; i < 2; i += 0.01)
    ck_assert_ldouble_eq_tol(s21_acos(s21_value + i), acosl(math_value + i),
                             S21_PRECISION);
}
END_TEST
...
START_TEST(s21_acos_test_2) {
  ...
  ck_assert_ldouble_eq_tol(s21_acos(s21_value), acosl(math_value),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_acos_test_4) {
  ...
  ck_assert_int_eq(isnan(s21_acos(s21_value)), isnan(acosl(math_value)));
  ck_assert_int_eq(signbit(s21_acos(s21_value)), signbit(acosl(math_value)));
}
END_TEST
...
Suite *s21_acos_tests(void) {
  Suite *suite = suite_create("s21_acos_tests_suite");
  TCase *tcase = tcase_create("s21_acos_tests_tcase");
  ...
  tcase_add_test(tcase, s21_acos_test_12);
  tcase_add_test(tcase, s21_acos_test_13);
  tcase_add_test(tcase, s21_acos_test_14);
  tcase_add_test(tcase, s21_acos_test_15);
  tcase_add_test(tcase, s21_acos_test_16);
  tcase_add_test(tcase, s21_acos_test_17);
  tcase_add_test(tcase, s21_acos_test_18);
  tcase_add_test(tcase, s21_acos_test_19);
  tcase_add_test(tcase, s21_acos_test_20);
  tcase_add_test(tcase, s21_acos_test_21);
  tcase_add_test(tcase, s21_acos_test_22);
  tcase_add_test(tcase, s21_acos_test_23);
  tcase_add_test(tcase, s21_acos_test_24);
  tcase_add_test(tcase, s21_acos_test_25);
  tcase_add_test(tcase, s21_acos_test_26);
  tcase_add_test(tcase, s21_acos_test_27);
  tcase_add_test(tcase, s21_acos_test_28);
  tcase_add_test(tcase, s21_acos_test_29);
  tcase_add_test(tcase, s21_acos_test_30);
  tcase_add_test(tcase, s21_acos_test_31);
