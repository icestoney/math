...
void tests_run() {
  Suite *tests_list[] = {
      ...
      // pow
      s21_pow_tests(), s21_pow_tests_no_valgrind(), s21_sqrt_tests(),
      // logs
      s21_exp_tests(), s21_exp_tests_no_valgrind(), s21_log_tests(),
      // abss
      s21_abs_tests(), s21_fabs_tests(),
      // rounds
      s21_ceil_tests(), s21_floor_tests(),
      //%
      s21_fmod_tests(), s21_fmod_tests_no_valgrind(), NULL};
