...
START_TEST(s21_floor_test_1) {
  ...
  ck_assert_ldouble_eq_tol(s21_floor(s21_value), floorl(math_value),
                           S21_PRECISION);
}
END_TEST
...
START_TEST(s21_floor_test_3) {
  ...
  ck_assert_int_eq(isnan(s21_floor(s21_value)), isnan(floorl(math_value)));
  ck_assert_int_eq(signbit(s21_floor(s21_value)), signbit(floorl(math_value)));
}
END_TEST
...
START_TEST(s21_floor_test_4) {
  ...
  ck_assert_int_eq(isinf(s21_floor(s21_value)), isinf(floorl(math_value)));
  ck_assert_int_eq(signbit(s21_floor(s21_value)), signbit(floorl(math_value)));
}
END_TEST
