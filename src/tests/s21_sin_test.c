...
START_TEST(s21_sin_test_1) {
  double s21_value = 1.;
  double math_value = 1.;
  ck_assert_ldouble_eq_tol(s21_sin(s21_value), sinl(math_value), S21_PRECISION);
}
END_TEST
...
START_TEST(s21_sin_test_7) {
  ...
  ck_assert_int_eq(isnan(s21_sin(s21_value)), isnan(sinl(math_value)));
  ck_assert_int_eq(signbit(s21_sin(s21_value)), signbit(sinl(math_value)));
}
END_TEST
...
Suite *s21_sin_tests(void) {
  Suite *suite = suite_create("s21_sin_tests_suite");
  TCase *tcase = tcase_create("s21_sin_tests_tcase");
  ...
  tcase_add_test(tcase, s21_sin_test_13);
  tcase_add_test(tcase, s21_sin_test_14);
  tcase_add_test(tcase, s21_sin_test_15);
  tcase_add_test(tcase, s21_sin_test_16);
  tcase_add_test(tcase, s21_sin_test_17);
  tcase_add_test(tcase, s21_sin_test_18);
  tcase_add_test(tcase, s21_sin_test_19);
  tcase_add_test(tcase, s21_sin_test_20);
  tcase_add_test(tcase, s21_sin_test_21);
  tcase_add_test(tcase, s21_sin_test_22);
  tcase_add_test(tcase, s21_sin_test_23);
  tcase_add_test(tcase, s21_sin_test_24);
  tcase_add_test(tcase, s21_sin_test_25);
  tcase_add_test(tcase, s21_sin_test_26);
  tcase_add_test(tcase, s21_sin_test_27);
  tcase_add_test(tcase, s21_sin_test_28);
  tcase_add_test(tcase, s21_sin_test_29);
  tcase_add_test(tcase, s21_sin_test_30);
  tcase_add_test(tcase, s21_sin_test_31);
  tcase_add_test(tcase, s21_sin_test_32);
  tcase_add_test(tcase, s21_sin_test_33);
